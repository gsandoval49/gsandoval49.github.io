/* browser.min.js v2.0 | @gsandoval49 */
    ...
    var t = {
        ...
        init: function() {
            ...
            var osInfo = [
                ...
                ["mac", /Macintosh.+Mac OS X/, function(e) { return e.replace("_", ".").replace("_", ""); }],
            ...
            for (var j = 0; j < osInfo.length; j++) {
                if (e.match(osInfo[j][1])) {
                    n = osInfo[j][0];
                    r = parseFloat(osInfo[j][2] ? osInfo[j][2](RegExp.$1) : RegExp.$1);
                    break;
                }
            }

            // Specific conditions for touch and mobile detection
            t.os = n;
            t.osVersion = r;
            t.touch = "wp" == t.os ? 0 < navigator.msMaxTouchPoints : !!("ontouchstart" in window);
            t.mobile = ["wp", "android", "ios"].includes(t.os);
        }
    };
...
/* COMMENTING OUT SO I CAN REFORMAT AND MAKE THIS FILE MORE READABLE AND UNDERSTAND THE LOGIC OF THIS FILE */
